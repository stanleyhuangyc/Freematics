...
var SIM = {
  ...
  refresh: function () {
    ...
    if (this.orientation) {
      document.getElementById('ori_alpha').value = Math.floor(
        this.orientation.alpha * 10
      );
      document.getElementById('ori_beta').value = Math.floor(
        this.orientation.beta * 10
      );
      document.getElementById('ori_gamma').value = Math.floor(
        this.orientation.gamma * 10
      );
    }
    if (battery) {
